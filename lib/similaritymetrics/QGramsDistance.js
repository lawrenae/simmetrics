...
function QGramsDistance(tokeniserToUse) {
	this.tokeniser = tokeniserToUse || (new TokeniserQGram3Extended());
	if(!this.tokeniser._isTokeniser) {
		throw new TypeError('Error: Invalid tokeniser');
	}
}

util.inherits(QGramsDistance, AbstractStringMetric);
QGramsDistance.prototype.getShortDecriptionString= function() {
	return 'QGramsDistance';
};
QGramsDistance.prototype.getLongDecriptionString= function() {
