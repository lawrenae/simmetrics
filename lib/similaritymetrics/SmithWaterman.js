...
SmithWaterman.prototype.getSimilarity = function(str1, str2) {
	var smithWaterman = this.getUnNormalisedSimilarity(assertType(str1, 'string'), assertType(str2, 'string'), true);

	var maxV = Math.min(str1.length, str2.length);
