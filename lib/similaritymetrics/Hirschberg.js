...
function Hirschberg() {}
inherits(Hirschberg, AbstractStringMetric, {
...
Hirschberg.prototype.algorithm_B = function(m, n, a, b, typeIgnore) {
	assertType(m, 'number', typeIgnore);
	assertType(n, 'number', typeIgnore);
	assertType(a, 'string', typeIgnore);
	assertType(b, 'string', typeIgnore);
...
Hirschberg.prototype.getUnNormalisedSimilarity =
	Hirschberg.prototype.getSimilarity = function(str1, str2) {
		...
		var l2 = assertType(str2, 'string').length;
		var l1 = assertType(str1, 'string').length;
